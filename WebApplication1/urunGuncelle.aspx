<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="urunGuncelle.aspx.cs" Inherits="WebApplication1.urunGuncelle" %>
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Güncelle" style="height: 29px" />
&nbsp;&nbsp;&nbsp;
